"""Near-field inspector -- controller-bound NF evaluator for the NF dock.

Pure NACD computation functions live in dc_cut.core.processing.nearfield.
This module provides the stateful NearFieldInspector that wires to controller arrays.
"""
