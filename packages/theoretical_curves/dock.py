...
class TheoreticalCurvesDock(QtWidgets.QDockWidget):
    ...
    def _load_csv_files(self, filepaths: List[str]) -> None:
        ...
        from dc_cut.packages.theoretical_curves.io import load_multiple_csv
    ...
    def _on_generate(self) -> None:
        ...
        from dc_cut.packages.theoretical_curves.config import GenerationConfig
        from dc_cut.packages.theoretical_curves.generator import TheoreticalCurveGenerator, validate_geopsy_installation
